...
// |=======| PALAVRAS RESERVADAS |=======|
enum PALAVRAS_RESERVADAS {CONST = 1, PR, INIT, ENDP, CHAR, INT, REAL, BOOL, DO, WHILE, ENDW, VAR, FROM, TO, BY,
                          ENDV, IF, ELIF, ELSE, ENDI, GETINT, GETCHAR, GETREAL, PUTINT, PUTCHAR, PUTREAL};
